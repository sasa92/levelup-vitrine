...
export default function NassimaProjectPage() {
  return (
        ...
        <div className="mb-24 bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-900 p-8 md:p-12 rounded-3xl relative overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            <span className="text-[10px] text-indigo-400 font-bold border border-indigo-500/30 bg-indigo-500/10 px-2.5 py-1 rounded-md uppercase tracking-widest">
              Statut : Déployé & Actif
            </span>
          </div>

          <h1 className="text-white text-3xl md:text-6xl font-black tracking-tight uppercase mb-6 leading-none">
            Nassima <span className="text-slate-500 font-light">— Portfolio Journaliste</span>
          </h1>

          <p className="text-slate-400 text-sm md:text-base leading-relaxed max-w-3xl mb-8 font-medium">
            Création d'une vitrine numérique sur-mesure pour une journaliste indépendante. Intégration d'un portfolio dynamique, d'un moteur de tri de reportages et d'une interface optimisée pour le grand écran comme pour le mobile.
          </p>

          <a 
            href="https://nassimaouail.42web.io/?i=1" 
            target="_blank" 
          ...
          >
            Visiter le site en direct <ExternalLink size={14} />
          </a>
        </div>
       ...
       {/* 3. COIN DÉMONSTRATION RESPONSIVE (ORDINATEUR + TÉLÉPHONE) */}
        <div className="mb-32">
          <div className="flex items-center gap-3 mb-12 border-b border-slate-900 pb-4">
            <span className="text-xs font-bold tracking-widest text-indigo-400 uppercase">01 / Preuve adaptative</span>
          </div>
            ...
            <section>
              ...
              <div className="bg-slate-900/40 border-l-2 border-indigo-500 p-6 md:p-8 backdrop-blur-md rounded-r-2xl border border-slate-900 shadow-xl">
                <p className="text-white text-base leading-relaxed mb-4 italic text-slate-200">
                  "Conception d'un écosystème numérique complet pour valoriser des reportages et articles de presse de façon immersive."
                </p>
                <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                  Le site intègre une architecture fluide connectée à des bases de données de stockage de médias, permettant de charger instantanément les articles, vidéos et maquettes éditoriales de la cliente sans impacter la vitesse de chargement globale.
                </p>
              </div>
            </section>
            ...
            <aside className="bg-slate-900/40 border border-slate-900 rounded-2xl overflow-hidden backdrop-blur-md shadow-2xl">
              ...
              <div className="p-6 space-y-6">
                <div>
                  ...
                  <p className="text-white text-sm font-medium">Nassima Ouail (Journaliste Média)</p>
                </div>
                ...
                <div className="bg-indigo-500/5 border border-indigo-500/20 p-4 rounded-xl flex items-start gap-3">
                  ...
                  <p className="text-slate-400 text-[11px] leading-relaxed font-medium">
                    Indexation et synchronisation automatisée des flux pour garantir une mise à jour immédiate du contenu éditorial.
                  </p>
                </div>
              </div>
            </aside>
