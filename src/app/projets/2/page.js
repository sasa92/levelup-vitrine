      ...
      <div className="max-w-6xl mx-auto px-6 pt-32">
        ...
        <div className="mb-24 bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-900 p-8 md:p-12 rounded-3xl relative overflow-hidden shadow-2xl">
          ...
          <h1 className="text-white text-3xl md:text-6xl font-black tracking-tight uppercase mb-6 leading-none">
             <span className="text-slate-500 font-light">Système de réservation & commande pour pizzeria</span>
          </h1>
            ...
            <section>
              ...
              <div className="bg-slate-900/40 border-l-2 border-indigo-500 p-6 md:p-8 backdrop-blur-md rounded-r-2xl border border-slate-900 shadow-xl">
                <p className="text-white text-base leading-relaxed mb-4 italic text-slate-200">
                  "Remplacer la prise de commande manuelle par un système fluide et intuitif, capable de gérer les pics d'affluence du vendredi soir tout en mettant en valeur le savoir-faire artisanal de l'établissement."
                </p>
                <p className="text-slate-400 text-xs md:text-sm leading-relaxed">
                
                Gestion dynamique du plan de salle, attribution automatique des créneaux horaires et confirmation instantanée.   <br></br>   <strong>Module de réservation temps réel : </strong>Gestion dynamique du plan de salle, attribution automatique des créneaux horaires et confirmation instantanée par SMS/e-mail.
                <br></br>
                <strong>Carte interactive & Menu : </strong>Présentation soignée des pizzas, gestion des allergènes, options de personnalisation d'ingrédients et mise à jour des stocks en un clic.
                <br></br>
                <strong>Click & Collect optimisé : </strong>Estimation automatique du temps de préparation en cuisine pour fluidifier les retraits aux heures de pointe.
                <br></br>
                <strong>Responsive & Mobile First : </strong>Interface pensée en priorité pour les commandes sur smartphone, garantissant un parcours utilisateur rapide en moins de quatre étapes.          </p>
              </div>
            </section>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Node.js', 'MySQL', 'REST API', 'JavaScript'].map(tag => (
